...
namespace ATMApp
{
    public class ATMApp : IUserLogin, IUserAccountActions, ITransaction
    {
        ...
        public void InitializeData()
        {
            ...
            {
                new UserAccount{Id=1, FullName = "Susan Vd Berg", AccountNumber=123456,CardNumber =321321, CardPin=123123,AccountBalance=50000.00m,IsLocked=false},
                ...
                new UserAccount{Id=3, FullName = "Kati Wiedos", AccountNumber=123555,CardNumber =987987, CardPin=789789,AccountBalance=2000.00m,IsLocked=true},
            };
        ...
        private void ProcessMenuoption()
        {
            switch(Validator.Convert<int>("an option:"))
            {
                ...
                case (int)AppMenu.Logout:
                    ...
                    Utility.PrintMessage("You have successfully been logged out. Please collect " +
                        "your ATM card.");
                    Run();
                    break;
                default:
        ...
        {
           Console.WriteLine("\nOnly multiples of 500 and 1000 Rand is allowed.\n");
        ...
        public void MakeWithDrawal()
        {
            ...
            {
                Utility.PrintMessage($"Withdrawal has failed. Your balance is too low to make withdraw" +
                    $"{Utility.FormatAmount(transaction_amt)}", false);
                return;
            }
            if((selectedAccount.AccountBalance - transaction_amt) < minimumKeptAmount)
            {
                Utility.PrintMessage($"Withdrawal has failed. Your account needs to have a " +
        ...
        private void ProcessInternalTransfer(InternalTransfer internalTransfer)
        {
           ...
           if(internalTransfer.TransferAmount > selectedAccount.AccountBalance)
            {
                Utility.PrintMessage($"Transfer failed. You do not have enough funds" +
           ...
           if((selectedAccount.AccountBalance - internalTransfer.TransferAmount) < minimumKeptAmount)
            {
                Utility.PrintMessage($"Transfer failed. Your account needs to have minimum of " +
